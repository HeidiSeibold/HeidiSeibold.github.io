...
<!-- TODOS: -->
<!-- - Insert links for OpenML, OpenML github, challenge platforms -->
<!-- - First create OpenML-R post  -->

OpenML is a very cool new online platform that aims at improving, as the name says,
Open Machine Learning. That means the platform stands for Open Data, Open Algorithms,
Open Research.
...
## Who can make use of the platform?
...
You will find plenty of data sets and the possiblity to make your algorithm public.
...
Platforms like kaggle, crowdanalytics and innocentive host challenges and give people only
part of the data so they can evaluate the performance of the algorithm on a separate data
set to (try to) prevent overfitting. So far OpenML does not do that, it always gives out 
...
them on the github page). But I think it can grow
to be a great thing one day.